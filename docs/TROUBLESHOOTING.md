# 🔧 Troubleshooting Guide — API Gateway Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-api-gateway/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/api-gateway/)
