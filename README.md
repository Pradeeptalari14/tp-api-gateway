# 🚦 API Gateway Studio
> Scaffold Nginx ingress, Traefik routes, rate limit headers, and routing proxies.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/api-gateway/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/api-gateway/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-api-gateway.git
cd tp-api-gateway
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/api-gateway/) |
